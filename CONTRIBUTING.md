...
```
$ go get github.com/moov-io/wire
```

Then, add your (or another user's) fork.

```
$ cd $GOPATH/src/github.com/moov-io/wire

$ git remote add $user git@github.com:$user/wire.git
...
Our Build pipeline utilizes [Travis-CI](https://travis-ci.com/moov-io/wire) to enforce many tools that you should add to your editor before issuing a pull request. Learn more about these tools on our [Go Report card](https://goreportcard.com/report/github.com/moov-io/wire)


##

In order for the code to be merged with a Pull requests we require a test file that covers the logic of the type. Refer to the [Go blog post on code coverage metrics](https://blog.golang.org/cover).

## References

* [Wikipeda: Fedwire](https://en.wikipedia.org/wiki/Fedwire)
* [FEDWIRE](https://www.frbservices.org/financial-services/wires/index.html)
