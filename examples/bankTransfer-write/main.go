...
func main() {
	...
	// Mandatory Fields ; senderSupplied, TypeSubType, InputMessageAccountabilityData
	...
	// TypeSubType
	typeSubtype := wire.NewTypeSubType()
	typeSubtype.TypeCode = wire.FundsTransfer
	typeSubtype.SubTypeCode = wire.BasicFundsTransfer
	fwm.SetTypeSubType(typeSubtype)
